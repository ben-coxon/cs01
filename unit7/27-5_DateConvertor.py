...
def date_converter(clndr, date):
    date_list = date.split("/")
    return date_list[1] + " " + clndr[int(date_list[0])] + " " + date_list[2]
...
def date_convertor(language, date):
	month, day, year = date.split('/')
	return day + " " + language[int(month)] + " " + year

## Slightly more elegant with the multiple assignment used to create the 
## month, day and year variables.
